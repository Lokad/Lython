...
""",
    ...
    [InlineData("str(abs(datetime.timedelta(days=-1)))", "1 day, 0:00:00")]
    [InlineData("str(abs(datetime.timedelta(days=1)))", "1 day, 0:00:00")]
    [InlineData("str(abs(datetime.timedelta(0)))", "0:00:00")]
    [InlineData("str(abs(datetime.timedelta(days=-2, seconds=3)))", "1 day, 23:59:57")]
    [InlineData("str(+datetime.timedelta(days=-1))", "-1 day, 0:00:00")]
    [InlineData("str(+datetime.timedelta(days=2, seconds=3))", "2 days, 0:00:03")]
    ...
    [InlineData("datetime.timezone.utc", "UTC")]
    [InlineData("repr(datetime.timezone.min)", "datetime.timezone(datetime.timedelta(days=-1, seconds=60))")]
    [InlineData("repr(datetime.timezone.max)", "datetime.timezone(datetime.timedelta(seconds=86340))")]
    [InlineData("str(datetime.timezone.min)", "UTC-23:59")]
    [InlineData("str(datetime.timezone.max)", "UTC+23:59")]
    [InlineData("datetime.timezone.min == datetime.timezone.min", "True")]
    [InlineData("datetime.timezone.min is datetime.timezone.min", "True")]
    [InlineData("datetime.timezone.min.utcoffset(None).total_seconds()", "-86340.0")]
    [InlineData("datetime.timezone.max.tzname(None)", "UTC+23:59")]
    [InlineData("datetime.timezone(datetime.timedelta(hours=2)).tzname(None)", "UTC+02:00")]
    [InlineData("datetime.datetime(2024, 1, 2, 3, 4, tzinfo=datetime.timezone(datetime.timedelta(hours=-5, minutes=-30))).tzname()", "UTC-05:30")]
    [InlineData("datetime.datetime(2024, 1, 2, 3, 4, tzinfo=datetime.timezone(datetime.timedelta(hours=2))).strftime('%Z')", "UTC+02:00")]
    [InlineData("datetime.timezone(datetime.timedelta(hours=2))", "UTC+02:00")]
    [InlineData("datetime.date.min is datetime.date.min", "True")]
    [InlineData("datetime.date.max is datetime.date.max", "True")]
    [InlineData("datetime.date.resolution is datetime.date.resolution", "True")]
    [InlineData("datetime.time.min is datetime.time.min", "True")]
    [InlineData("datetime.time.max is datetime.time.max", "True")]
    [InlineData("datetime.time.resolution is datetime.time.resolution", "True")]
    [InlineData("datetime.datetime.min is datetime.datetime.min", "True")]
    [InlineData("datetime.datetime.max is datetime.datetime.max", "True")]
    [InlineData("datetime.datetime.resolution is datetime.datetime.resolution", "True")]

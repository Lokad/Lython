...
public sealed class BuiltinValidationScenarioTests
{
    ...
    [InlineData("import datetime\ndatetime.time(1, 2, 3).replace(tzinfo=1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.time(1, 2, 3, tzinfo=1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.timezone(datetime.timedelta(0), 123)\n", "TypeError", "timezone() argument 2 must be str, not int")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.time(1, 2, 3).replace(tzinfo=J())\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'J'")]
    [InlineData("import datetime\ndatetime.time(1, 2, 3).replace(tzinfo=int)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'type'")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 1, tzinfo=\"x\")\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'str'")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 1).replace(tzinfo=1.5)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'float'")]
    [InlineData("import datetime\ndatetime.time(1, 2, 3, tzinfo=True)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'bool'")]
    [InlineData("import datetime\ndatetime.datetime.now(1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.datetime.fromtimestamp(0, 1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 1).astimezone(1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.datetime.combine(datetime.date(2024, 1, 2), datetime.time(3, 4), 1)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'int'")]
    [InlineData("import datetime\ndatetime.datetime.combine(1, datetime.time(3, 4))\n", "TypeError", "combine() argument 1 must be datetime.date, not int")]
    [InlineData("import datetime\ndatetime.datetime.combine(datetime.date(2024, 1, 2), 1)\n", "TypeError", "combine() argument 2 must be datetime.time, not int")]
    [InlineData("import datetime\ndatetime.datetime.combine(None, datetime.time(3, 4))\n", "TypeError", "combine() argument 1 must be datetime.date, not None")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.datetime.combine(J(), datetime.time(3, 4))\n", "TypeError", "combine() argument 1 must be datetime.date, not J")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.datetime.combine(datetime.date(2024, 1, 2), J())\n", "TypeError", "combine() argument 2 must be datetime.time, not J")]
    [InlineData("import datetime\ndatetime.datetime.now(int)\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'type'")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 1).astimezone(\"x\")\n", "TypeError", "tzinfo argument must be None or of a tzinfo subclass, not type 'str'")]
    [InlineData("import datetime\ndatetime.time(1, 2, 3).isoformat(timespec=None)\n", "TypeError", "isoformat() argument 1 must be str, not None")]
    [InlineData("import datetime\ndatetime.date.fromisoformat(123)\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\ndatetime.time.fromisoformat(None)\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\ndatetime.datetime.fromisoformat(1.5)\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\ndatetime.date.fromisoformat(True)\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\ndatetime.date.fromisoformat(b'2024-01-02')\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.date.fromisoformat(J())\n", "TypeError", "fromisoformat: argument must be str")]
    [InlineData("import datetime\ndatetime.datetime.strptime(123, '%Y')\n", "TypeError", "strptime() argument 1 must be str, not int")]
    [InlineData("import datetime\ndatetime.datetime.strptime(None, '%Y')\n", "TypeError", "strptime() argument 1 must be str, not None")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.datetime.strptime(J(), '%Y')\n", "TypeError", "strptime() argument 1 must be str, not J")]
    [InlineData("import datetime\ndatetime.datetime.strptime(int, '%Y')\n", "TypeError", "strptime() argument 1 must be str, not type")]
    [InlineData("import datetime\ndatetime.datetime.strptime('2024', 1.5)\n", "TypeError", "strptime() argument 2 must be str, not float")]
    [InlineData("import datetime\ndatetime.datetime.strptime('2024', None)\n", "TypeError", "strptime() argument 2 must be str, not None")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 2).strftime(123)\n", "TypeError", "strftime() argument 1 must be str, not int")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 2).strftime(None)\n", "TypeError", "strftime() argument 1 must be str, not None")]
    [InlineData("import datetime\ndatetime.date(2024, 1, 2).strftime(True)\n", "TypeError", "strftime() argument 1 must be str, not bool")]
    [InlineData("import datetime\ndatetime.time(3, 4).strftime(b'x')\n", "TypeError", "strftime() argument 1 must be str, not bytes")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 2).strftime(int)\n", "TypeError", "strftime() argument 1 must be str, not type")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.date(2024, 1, 2).strftime(J())\n", "TypeError", "strftime() argument 1 must be str, not J")]
    [InlineData("import datetime\ndatetime.datetime(2024, 1, 2).__format__(123)\n", "TypeError", "__format__() argument 1 must be str, not int")]
    [InlineData("import datetime\ndatetime.date(2024, 1, 2).__format__(None)\n", "TypeError", "__format__() argument 1 must be str, not None")]
    [InlineData("import datetime\ndatetime.time(3, 4).__format__(1.5)\n", "TypeError", "__format__() argument 1 must be str, not float")]
    [InlineData("format('a', 123)\n", "TypeError", "format() argument 2 must be str, not int")]
    [InlineData("format('a', None)\n", "TypeError", "format() argument 2 must be str, not None")]
    [InlineData("import datetime\nformat(datetime.datetime(2024, 1, 2), True)\n", "TypeError", "format() argument 2 must be str, not bool")]
    [InlineData("format('a', b'x')\n", "TypeError", "format() argument 2 must be str, not bytes")]
    [InlineData("import datetime\nabs(datetime.date(2024, 1, 2))\n", "TypeError", "bad operand type for abs(): 'datetime.date'")]
    [InlineData("import datetime\nabs(datetime.datetime(2024, 1, 2))\n", "TypeError", "bad operand type for abs(): 'datetime.datetime'")]
    [InlineData("import datetime\nabs(datetime.time(1, 2))\n", "TypeError", "bad operand type for abs(): 'datetime.time'")]
    [InlineData("import datetime\nabs(datetime.timezone.utc)\n", "TypeError", "bad operand type for abs(): 'datetime.timezone'")]
    [InlineData("import datetime\nround(datetime.timedelta(days=1))\n", "TypeError", "type datetime.timedelta doesn't define __round__ method")]
    [InlineData("import datetime\nrange(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nlist(enumerate([1, 2], datetime.date(2024, 1, 1)))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nint('10', datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nchr(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nhex(datetime.time(1, 2))\n", "TypeError", "'datetime.time' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nround(1, datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\n(5).to_bytes(datetime.date(2024, 1, 1), 'big')\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ndatetime.date(datetime.date(2024, 1, 1), 1, 1)\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ndatetime.date.fromordinal(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ndatetime.date.fromisocalendar(datetime.date(2024, 1, 1), 1, 2)\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ndatetime.datetime.fromtimestamp(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport itertools\nlist(itertools.repeat(1, datetime.date(2024, 1, 1)))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport itertools\nlist(itertools.product([1], [2], repeat=datetime.date(2024, 1, 1)))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport collections\ncollections.deque([1]).insert(datetime.date(2024, 1, 1), 2)\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport operator\noperator.index(datetime.datetime(2024, 1, 2))\n", "TypeError", "'datetime.datetime' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ngetattr([1], 'insert')(datetime.date(2024, 1, 1), 2)\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport time\ntime.gmtime(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nslice(1, 2).indices(datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ngetattr(b'a', 'split')(None, datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport re\ngetattr(re.compile('x'), 'match')('xx', datetime.date(2024, 1, 1))\n", "TypeError", "'datetime.date' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nimport operator\noperator.index(datetime.time(1, 2))\n", "TypeError", "'datetime.time' object cannot be interpreted as an integer")]
    [InlineData("import datetime\nrange(datetime.timedelta(1))\n", "TypeError", "'datetime.timedelta' object cannot be interpreted as an integer")]
    [InlineData("import datetime\ndivmod(datetime.timedelta(5), 0)\n", "TypeError", "unsupported operand type(s) for divmod(): 'datetime.timedelta' and 'int'")]
    [InlineData("import datetime\ndivmod(5, datetime.timedelta(1))\n", "TypeError", "unsupported operand type(s) for divmod(): 'int' and 'datetime.timedelta'")]
    [InlineData("import datetime\ndivmod(datetime.timedelta(5), 2.0)\n", "TypeError", "unsupported operand type(s) for divmod(): 'datetime.timedelta' and 'float'")]
    ...
    [InlineData("-1 in b'abc'\n", "ValueError", "byte must be in range(0, 256)")]
    [InlineData("import operator\noperator.contains(b'abc', 'a')\n", "TypeError", "a bytes-like object is required, not 'str'")]
    [InlineData("import operator\noperator.contains(b'abc', None)\n", "TypeError", "a bytes-like object is required, not 'NoneType'")]
    [InlineData("import operator\nclass J:\n pass\noperator.contains(b'abc', J())\n", "TypeError", "a bytes-like object is required, not 'J'")]
    [InlineData("import operator\noperator.contains(b'abc', 1.5)\n", "TypeError", "a bytes-like object is required, not 'float'")]
    [InlineData("'a' in b'abc'\n", "compile", "Right operand does not support membership testing")]
    [InlineData("b'a' < 'b'\n", "compile", "'<' not supported between instances of 'bytes' and 'str'")]
    ...
    [InlineData("import datetime\ndatetime.timezone(None)\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not None")]
    [InlineData("import datetime\ndatetime.timezone(True)\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not bool")]
    [InlineData("import datetime\ndatetime.timezone(1.5)\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not float")]
    [InlineData("import datetime\nclass J:\n pass\ndatetime.timezone(J())\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not J")]
    [InlineData("import datetime\ndatetime.timezone(int)\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not type")]
    [InlineData("import datetime\ndatetime.timezone(b'x')\n", "TypeError", "timezone() argument 1 must be datetime.timedelta, not bytes")]

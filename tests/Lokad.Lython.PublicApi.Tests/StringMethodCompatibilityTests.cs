...
public sealed class StringMethodCompatibilityTests
{
    ...
    [InlineData("\"{:.2f}\".format(3.14159)", "3.14")]
    [InlineData("\"{:,}\".format(1000000)", "1,000,000")]
    [InlineData("\"{:+d}\".format(5)", "+5")]
    [InlineData("\"{:>5}\".format(5)", "    5")]
    [InlineData("\"{:*^7}\".format(5)", "***5***")]
    [InlineData("\"{:.3}\".format(\"abcdef\")", "abc")]
    [InlineData("\"{!r}\".format(\"ab\")", "\'ab\'")]
    [InlineData("\"{0!r:>6}\".format(\"ab\")", "  \'ab\'")]
    [InlineData("\"{0:>{w}}\".format(\"ab\", w=5)", "   ab")]
    [InlineData("\"{007}\".format(\"a\", \"b\", \"c\", \"d\", \"e\", \"f\", \"g\", \"h\")", "h")]
    [InlineData("\"{{}}\".format()", "{}")]

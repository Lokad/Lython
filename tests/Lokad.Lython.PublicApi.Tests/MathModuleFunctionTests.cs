...
""",
    ...
    [Theory]
    [InlineData("math.factorial(-1)", "ValueError", "factorial() not defined for negative values")]
    [InlineData("math.factorial(3.0)", "compile", "expects an integer argument")]
    [InlineData("math.comb(5, -1)", "ValueError", "k must be a non-negative integer")]
    [InlineData("math.isqrt(-1)", "ValueError", "isqrt() argument must be nonnegative")]
    [InlineData("math.comb(-1, 2)", "ValueError", "n must be a non-negative integer")]
    [InlineData("math.perm(-1, 2)", "ValueError", "n must be a non-negative integer")]
    [InlineData("math.perm(2, -1)", "ValueError", "k must be a non-negative integer")]
    [InlineData("math.perm(-1)", "ValueError", "n must be a non-negative integer")]
    [InlineData("import math\ngetattr(math, 'factorial')('x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'comb')(1, 'x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'isqrt')(1.5)\n", "TypeError", "'float' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'gcd')(1, 'x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'perm')('x', 1)\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'lcm')(1, 'x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'ldexp')(1.0, 'x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]
    [InlineData("import math\ngetattr(math, 'nextafter')(1.0, 2.0, steps='x')\n", "TypeError", "'str' object cannot be interpreted as an integer")]

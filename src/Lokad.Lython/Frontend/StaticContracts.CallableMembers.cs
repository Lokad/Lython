...
internal static partial class StaticContracts
{
    ...
    private static StaticCallableContract[] CreateCallableContracts()
    {
        ...
        [
            ...
            new(AbstractValueKind.SetType, "add", 1, 1, "LA3135", "set.add(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),
            new(AbstractValueKind.SetType, "discard", 1, 1, "LA3136", "set.discard(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),
            new(AbstractValueKind.SetType, "remove", 1, 1, "LA3137", "set.remove(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),

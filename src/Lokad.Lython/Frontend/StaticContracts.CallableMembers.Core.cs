...
internal static partial class StaticContracts
{
    private static class CoreCallableContractCatalog
    {
        ...
        new(AbstractValueKind.CollectionsDefaultDict, "__iter__", 0, 0, "LA3114", "defaultdict.__iter__() expects no arguments."),
        new(AbstractValueKind.CollectionsDefaultDict, "__len__", 0, 0, "LA3114", "defaultdict.__len__() expects no arguments."),
        new(AbstractValueKind.CollectionsDefaultDict, "__contains__", 1, 1, "LA3114", "defaultdict.__contains__(item) expects one argument.", parameterNames: ["item"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__getitem__", 1, 1, "LA3114", "defaultdict.__getitem__(index) expects one argument.", parameterNames: ["index"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__setitem__", 2, 2, "LA3114", "defaultdict.__setitem__(index, value) expects two arguments.", StaticMutationKind.MutatesReceiver, ["index", "value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__delitem__", 1, 1, "LA3114", "defaultdict.__delitem__(index) expects one argument.", StaticMutationKind.MutatesReceiver, ["index"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__or__", 1, 1, "LA3114", "defaultdict.__or__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__ror__", 1, 1, "LA3114", "defaultdict.__ror__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__ior__", 1, 1, "LA3114", "defaultdict.__ior__(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__eq__", 1, 1, "LA3114", "defaultdict.__eq__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__ne__", 1, 1, "LA3114", "defaultdict.__ne__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__lt__", 1, 1, "LA3114", "defaultdict.__lt__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__le__", 1, 1, "LA3114", "defaultdict.__le__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDefaultDict, "__gt__", 1, 1, "LA3114", "defaultdict.__gt__(value) expects one argument.", parameterNames: ["value"]),
        ...
        new(AbstractValueKind.CollectionsCounter, "__iter__", 0, 0, "LA3114", "Counter.__iter__() expects no arguments."),
        new(AbstractValueKind.CollectionsCounter, "__len__", 0, 0, "LA3114", "Counter.__len__() expects no arguments."),
        new(AbstractValueKind.CollectionsCounter, "__contains__", 1, 1, "LA3114", "Counter.__contains__(item) expects one argument.", parameterNames: ["item"]),
        new(AbstractValueKind.CollectionsCounter, "__getitem__", 1, 1, "LA3114", "Counter.__getitem__(index) expects one argument.", parameterNames: ["index"]),
        new(AbstractValueKind.CollectionsCounter, "__setitem__", 2, 2, "LA3114", "Counter.__setitem__(index, value) expects two arguments.", StaticMutationKind.MutatesReceiver, ["index", "value"]),
        new(AbstractValueKind.CollectionsCounter, "__delitem__", 1, 1, "LA3114", "Counter.__delitem__(index) expects one argument.", StaticMutationKind.MutatesReceiver, ["index"]),
        new(AbstractValueKind.CollectionsCounter, "__or__", 1, 1, "LA3114", "Counter.__or__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__and__", 1, 1, "LA3114", "Counter.__and__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__sub__", 1, 1, "LA3114", "Counter.__sub__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__ror__", 1, 1, "LA3114", "Counter.__ror__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__ior__", 1, 1, "LA3114", "Counter.__ior__(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__iand__", 1, 1, "LA3114", "Counter.__iand__(value) expects one argument.", StaticMutationKind.MutatesReceiver, ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__eq__", 1, 1, "LA3114", "Counter.__eq__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__ne__", 1, 1, "LA3114", "Counter.__ne__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__lt__", 1, 1, "LA3114", "Counter.__lt__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__le__", 1, 1, "LA3114", "Counter.__le__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__gt__", 1, 1, "LA3114", "Counter.__gt__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__ge__", 1, 1, "LA3114", "Counter.__ge__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsCounter, "__reversed__", 0, 0, "LA3114", "Counter.__reversed__() expects no arguments."),
        ...
        new(AbstractValueKind.CollectionsDeque, "__iter__", 0, 0, "LA3114", "deque.__iter__() expects no arguments."),
        new(AbstractValueKind.CollectionsDeque, "__len__", 0, 0, "LA3114", "deque.__len__() expects no arguments."),
        new(AbstractValueKind.CollectionsDeque, "__contains__", 1, 1, "LA3114", "deque.__contains__(item) expects one argument.", parameterNames: ["item"]),
        new(AbstractValueKind.CollectionsDeque, "__getitem__", 1, 1, "LA3114", "deque.__getitem__(index) expects one argument.", parameterNames: ["index"]),
        new(AbstractValueKind.CollectionsDeque, "__setitem__", 2, 2, "LA3114", "deque.__setitem__(index, value) expects two arguments.", StaticMutationKind.MutatesReceiver, ["index", "value"]),
        new(AbstractValueKind.CollectionsDeque, "__delitem__", 1, 1, "LA3114", "deque.__delitem__(index) expects one argument.", StaticMutationKind.MutatesReceiver, ["index"]),
        new(AbstractValueKind.CollectionsDeque, "__add__", 1, 1, "LA3114", "deque.__add__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDeque, "__mul__", 1, 1, "LA3114", "deque.__mul__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDeque, "__rmul__", 1, 1, "LA3114", "deque.__rmul__(value) expects one argument.", parameterNames: ["value"]),
        new(AbstractValueKind.CollectionsDeque, "__reversed__", 0, 0, "LA3114", "deque.__reversed__() expects no arguments."),
        ...
        new(AbstractValueKind.CollectionsChainMap, "__len__", 0, 0, "LA3114", "ChainMap.__len__() expects no arguments."),
        new(AbstractValueKind.CollectionsChainMap, "__contains__", 1, 1, "LA3114", "ChainMap.__contains__(item) expects one argument.", parameterNames: ["item"]),
        new(AbstractValueKind.CollectionsChainMap, "__getitem__", 1, 1, "LA3114", "ChainMap.__getitem__(index) expects one argument.", parameterNames: ["index"]),
        new(AbstractValueKind.CollectionsChainMap, "__setitem__", 2, 2, "LA3114", "ChainMap.__setitem__(index, value) expects two arguments.", StaticMutationKind.MutatesReceiver, ["index", "value"]),
        new(AbstractValueKind.CollectionsChainMap, "__delitem__", 1, 1, "LA3114", "ChainMap.__delitem__(index) expects one argument.", StaticMutationKind.MutatesReceiver, ["index"]),

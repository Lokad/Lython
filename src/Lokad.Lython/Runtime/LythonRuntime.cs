    ...
    internal sealed partial class ExecutionContext
    {
        ...
        private Dictionary<string, object> CreateBuiltinVariables(string? sourcePath, string moduleName)
        {
            ...
            var builtins = new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["bool"] = new BuiltinCallable(new LythonCallableSignature("bool", ["value"], PositionalOnlyCount: 1), Bool),
                ["int"] = new BuiltinCallable(new LythonCallableSignature("int", ["x"], PositionalOnlyCount: 1), Int),
                ["float"] = new BuiltinCallable(new LythonCallableSignature("float", ["value"], PositionalOnlyCount: 1), Float),

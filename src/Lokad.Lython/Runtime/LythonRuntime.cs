    ...
    internal sealed partial class ExecutionContext
    {
        ...
        private Dictionary<string, object> CreateBuiltinVariables(string? sourcePath, string moduleName)
        {
            ...
            var builtins = new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["str"] = new BuiltinCallable(new LythonCallableSignature("str", ["object", "encoding", "errors"], RequiredCount: 0, PositionalOnlyCount: 1), Str),
                ...
                ["sorted"] = new BuiltinCallable(new LythonCallableSignature("sorted", ["iterable", "key", "reverse"], RequiredCount: 1, MaxPositionalCount: 1, PositionalOnlyCount: 1), Sorted, SortedAsync),
                ...
                ["sum"] = new BuiltinCallable(new LythonCallableSignature("sum", ["iterable", "start"], RequiredCount: 1, PositionalOnlyCount: 1), Sum, SumAsync),
                ...
                ["enumerate"] = new BuiltinCallable(new LythonCallableSignature("enumerate", ["iterable", "start"], RequiredCount: 1, PositionalOnlyCount: 1), Enumerate, EnumerateAsync),
                ["zip"] = new BuiltinCallable("zip", Zip, ZipAsync),
                ["iter"] = new BuiltinCallable("iter", Iter),
                ["next"] = new BuiltinCallable(new LythonCallableSignature("next", ["iterator", "default"], RequiredCount: 1, PositionalOnlyCount: 2), Next, NextAsync),
                ...
                ["bool"] = new BuiltinCallable(new LythonCallableSignature("bool", ["value"], RequiredCount: 0, PositionalOnlyCount: 1), Bool),
                ["int"] = new BuiltinCallable(new LythonCallableSignature("int", ["x", "base"], RequiredCount: 0, PositionalOnlyCount: 1), Int),
                ["float"] = new BuiltinCallable(new LythonCallableSignature("float", ["value"], RequiredCount: 0, PositionalOnlyCount: 1), Float),
                ["bytes"] = new BuiltinCallable(new LythonCallableSignature("bytes", ["source", "encoding", "errors"], RequiredCount: 0, PositionalOnlyCount: 1), Bytes),

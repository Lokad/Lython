    ...
    internal sealed partial class ExecutionContext
    {
        ...
        private Dictionary<string, object> CreateBuiltinVariables()
        {
            ...
            var builtins = new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["str"] = new BuiltinCallable(new LythonCallableSignature("str", ["object", "encoding", "errors"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Str),
                ...
                ["sorted"] = new BuiltinCallable(new LythonCallableSignature("sorted", ["iterable", "key", "reverse"], RequiredCount: 1, MaxPositionalCount: 1, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Sorted, SortedAsync),
                ["any"] = new BuiltinCallable("any", Any, AnyAsync),
                ["all"] = new BuiltinCallable("all", All, AllAsync),
                ["min"] = new MinMaxCallable(isMin: true),
                ["max"] = new MinMaxCallable(isMin: false),
                ["sum"] = new BuiltinCallable(new LythonCallableSignature("sum", ["iterable", "start"], RequiredCount: 1, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Sum, SumAsync),
                ...
                ["enumerate"] = new BuiltinCallable(new LythonCallableSignature("enumerate", ["iterable", "start"], RequiredCount: 1, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Enumerate),
                ["zip"] = new ZipCallable(),
                ["iter"] = new BuiltinCallable("iter", Iter),
                ["next"] = new BuiltinCallable(new LythonCallableSignature("next", ["iterator", "default"], RequiredCount: 1, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 2), Next, NextAsync),
                ...
                ["bool"] = new BuiltinCallable(new LythonCallableSignature("bool", ["value"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Bool),
                ["int"] = new BuiltinCallable(new LythonCallableSignature("int", ["x", "base"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Int),
                ["float"] = new BuiltinCallable(new LythonCallableSignature("float", ["value"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Float),
                ["bytes"] = new BuiltinCallable(new LythonCallableSignature("bytes", ["source", "encoding", "errors"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Bytes),
                ...
                ["list"] = new BuiltinCallable(new LythonCallableSignature("list", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), List, ListAsync),
                ["tuple"] = new BuiltinCallable(new LythonCallableSignature("tuple", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Tuple, TupleAsync),
                ["dict"] = new DictCallable(),
                ["set"] = new BuiltinCallable(new LythonCallableSignature("set", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, AllowsExtraKeywords: false, AllowsExtraPositional: false, PositionalOnlyCount: 1), Set, SetAsync),
            };

...
internal sealed partial class LythonRuntime
{
    ...
    private static object EvaluateExecutableBinary(ExecutableBinaryOperator op, object left, object right, LythonSourceSpan span, ExecutionContext context)
        => op switch
        {
            ...
            ExecutableBinaryOperator.Less => CompareRelational(left, right, span, static value => value < 0),
            ExecutableBinaryOperator.LessEqual => CompareRelational(left, right, span, static value => value <= 0),
            ExecutableBinaryOperator.Greater => CompareRelational(left, right, span, static value => value > 0),

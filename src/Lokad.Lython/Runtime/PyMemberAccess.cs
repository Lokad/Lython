...
internal static class PyMemberAccess
{
    ...
    private static readonly IReadOnlyDictionary<Type, ExactMemberResolver> ExactResolvers =
        new Dictionary<Type, ExactMemberResolver>
        {
            ...
            [typeof(LythonRuntime.DictValuesView)] = static (object target, string memberName, [MaybeNullWhen(false)] out object value) => LythonRuntime.DictViewMembers.TryGetValuesMember((LythonRuntime.DictValuesView)target, memberName, out value),
            ...
            [typeof(ChainMapValuesView)] = static (object target, string memberName, [MaybeNullWhen(false)] out object value) => LythonRuntime.DictViewMembers.TryGetChainMapValuesMember((ChainMapValuesView)target, memberName, out value),

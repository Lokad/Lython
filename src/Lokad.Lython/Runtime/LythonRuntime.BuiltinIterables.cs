...
internal sealed partial class LythonRuntime
{
    ...
    private static readonly string[] BytesDirNames = ["count", "decode", "endswith", "find", "fromhex", "hex", "index", "isalnum", "isalpha", "isascii", "isdigit", "islower", "isspace", "istitle", "isupper", "maketrans", "replace", "rfind", "rindex", "startswith", "translate"];

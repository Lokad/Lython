    ...
    internal sealed partial class ExecutionContext
    {
        ...
        private Dictionary<string, object> CreateBuiltinVariables()
        {
            ...
            var builtins = new Dictionary<string, object>(StringComparer.Ordinal)
            {
                ...
                ["str"] = BuiltinCallable.Create(LythonCallableSignature.Create("str", ["object", "encoding", "errors"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Str),
                ...
                ["sorted"] = BuiltinCallable.Create(LythonCallableSignature.Create("sorted", ["iterable", "key", "reverse"], RequiredCount: 1, MaxPositionalCount: 1, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Sorted, SortedAsync),
                ...
                ["sum"] = BuiltinCallable.Create(LythonCallableSignature.Create("sum", ["iterable", "start"], RequiredCount: 1, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Sum, SumAsync),
                ...
                ["enumerate"] = BuiltinCallable.Create(LythonCallableSignature.Create("enumerate", ["iterable", "start"], RequiredCount: 1, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Enumerate),
                ["zip"] = new ZipCallable(),
                ["iter"] = BuiltinCallable.Create("iter", Iter),
                ["next"] = BuiltinCallable.Create(LythonCallableSignature.Create("next", ["iterator", "default"], RequiredCount: 1, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 2), Next, NextAsync),
                ...
                ["bool"] = BuiltinCallable.Create(LythonCallableSignature.Create("bool", ["value"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Bool),
                ["int"] = BuiltinCallable.Create(LythonCallableSignature.Create("int", ["x", "base"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Int),
                ["float"] = BuiltinCallable.Create(LythonCallableSignature.Create("float", ["value"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Float),
                ["bytes"] = BuiltinCallable.Create(LythonCallableSignature.Create("bytes", ["source", "encoding", "errors"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Bytes),
                ...
                ["list"] = BuiltinCallable.Create(LythonCallableSignature.Create("list", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), List, ListAsync),
                ["tuple"] = BuiltinCallable.Create(LythonCallableSignature.Create("tuple", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Tuple, TupleAsync),
                ["dict"] = new DictCallable(),
                ["set"] = BuiltinCallable.Create(LythonCallableSignature.Create("set", ["iterable"], RequiredCount: 0, MaxPositionalCount: null, VariadicParameters: LythonVariadicParameters.None, PositionalOnlyCount: 1), Set, SetAsync),
            };
